...
public class PotatoVersionBuildDateController {

    private static final String PROP = "persist.potato.date";
    private static final int POTATO_VERSION_LABEL_ID = R.id.potato_version_bd_label;
    private static final int POTATO_VERSION_VALUE_ID = R.id.potato_version_bd_value;

    private final PotatoVersionDialogFragment mDialog;

    PotatoVersionBuildDateController(PotatoVersionDialogFragment dialog) {
        mDialog = dialog;
    }
