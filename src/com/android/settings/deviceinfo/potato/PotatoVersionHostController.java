...
public class PotatoVersionHostController {

    private static final String PROP = "ro.build.host";
    private static final int POTATO_VERSION_LABEL_ID = R.id.potato_version_host_label;
    private static final int POTATO_VERSION_VALUE_ID = R.id.potato_version_host_value;

    private final PotatoVersionDialogFragment mDialog;

    PotatoVersionHostController(PotatoVersionDialogFragment dialog) {
        mDialog = dialog;
    }
